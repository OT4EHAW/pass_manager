...
function gostencrypt(message, key){
    let msg = GostCipher.encrypt(message, key);
    return msg.toString();

  }

  function gostdecrypt(message, key){

    let decryptedMessage = GostCipher.decrypt(message, key);
